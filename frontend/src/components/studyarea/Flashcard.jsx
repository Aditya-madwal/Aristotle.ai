        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* Back of card */}
                    <div
                        className="absolute w-full h-full backface-hidden rounded-xl shadow-lg p-6 flex flex-col rotate-y-180 bg-white"
                    >
            ...
            {isViewerOpen && (
                ...
                topic={topic}
                    ...
                    onClose={() => {setIsViewerOpen(false); setIsFlipped(false)}} 
                />
            )}
        </>
    );
